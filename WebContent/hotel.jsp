					...
					%>
						<table class="object_infoT" cellpadding="0" cellspacing="0" border="0">
							<tr>
								...
								<td class="object_info_val"><%=hotel.getName()%></td>
							</tr>
							<tr>
								<td class="object_info_desc">Phone:</td>
								<td class="object_info_val"><%=hotel.getTelephone()%></td>
							</tr>
							<tr>
								<td class="object_info_desc">Address:</td>
								<td class="object_info_val"><%=hotel.getAdress()%></td>
							</tr>
							<tr>
								<td class="object_info_desc">Email:</td>
								<td class="object_info_val"><%=hotel.getEmail()%></td>
							</tr>
							<tr>
								<td class="object_info_desc">Stars:</td>
								<td class="object_info_val"><%=hotel.getStars()%></td>
							</tr>
						...
						<table class="commentsT" cellpadding="0" cellspacing="0" border="0">
							...
							<tr>
								<td class="commentsW">
									<%
									List<Comment> comments = CommentStorage.loadComments(1, hotel.getId()); 	
